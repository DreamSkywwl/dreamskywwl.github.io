...
let arr = [
    ...
    { name: '解析图片', url: 'https://dreamskywwl.github.io/dynamic/html/downloadPic.html', category: 'other' },
    { name: 'Python_Code', url: 'https://dreamskywwl.github.io/dynamic/html/python.html', category: 'other' },
    { name: '常用工具', url: 'https://dreamskywwl.github.io/dynamic/html/copyContent.html', category: 'other' },
    // { name: '文案生成器', url: 'https://dreamskywwl.github.io/dynamic/html/copyText.html', category: 'other' },
    { name: 'Github', url: 'https://github.com/DreamSkywwl', category: 'code' },



    { name: 'Gitee', url: 'https://gitee.com', category: 'code' },
    { name: 'element Plus', url: 'https://dreamskywwl.github.io/zh-CN', category: 'code' },
